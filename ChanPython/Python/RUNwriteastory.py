...
dogSEN = 'she\'s my dog', 'the sweetest dog you ever met'
gfSEN = 'she\'s my girlfriend', 'the most beautiful gal you ever saw', 'love of my life'

revengeSEN = 'but she crossed me and now i will get my revenge', 'regardless i will have my vengeance'
murderSEN = 'i\'m going to kill her anyway', 'but i must kill her'

story1a = dogSEN, gfSEN
story2a = revengeSEN, murderSEN

story1adog = 'i will make sure she is treated well.'
story1agf = 'i despair over this need to take ' + protag1 + '\'s ' + 'life.'
story2adog = 'don\'t worry. she\'ll never see it coming.'
story2agf = 'she deserves it'
...
def storyrunner():
    story2 = rc(story2a)
    story1 = rc(story1a)
    storyrunlist = story1, story2
    storyrun = rc(storyrunlist)
    if (storyrun == story1):
        if (story1 == dogSEN):
            print(rc(dogSEN) + ". ", end="")
            return story1adog
            ...
            print(rc(gfSEN) + ". ", end="")
            return story1agf
    elif (storyrun == story2):
        if (story2 == revengeSEN):
            print(rc(rc(story1a)) + ". ", end="")
            print(rc(revengeSEN) + ". ", end="")
            return story2adog
        elif (story2 == murderSEN):
            print(rc(rc(story1a)) + ". ", end="")
            print(rc(murderSEN) + ". ", end="")
            return story2agf
...
#print("i", rc(rc(feel)), rc(creature) + "s, " + rc(about), rc(base), "and", rc(base))
#print(placename.capitalize(), protag1.capitalize())

print("i love", protag1 + ". ", end="")
print(storyrunner())
#"is not your typical small city... unless your typical small city have demons running loose in your sewers, a half-crazed skeleton angel thinking he's your city's super-hero, and a ghost for your deputy mayor? ...oh, and your mayor has a jack-o-lantern for a head. This is the city of Night-Moor, have a fear filled day! 	
# i love sally. 
# rc(1or2)
# path1 = sally is my dog, sally is my girlfriend
# path2 = but since she murdered me, i'll get revenge, but i'm going to kill her anyway
