...
aka = 'more popularly known as', 'also known online as', 'who goes by the online handle', 'often referred to by friends as',
...
injurytype = 'clawmark', 'knife', 'teeth', 'bite', 'crisscrossing', 'smoking',
injury = 'injuries', 'wounds', 'gashes', 'tears', 'cuts', 'gouges', 'slashes', 'lacerations', 'lesions', 'trauma',
desc_as = 'what onlookers described as', 'what police reported as', 'what one anonymous source described as', 'what one witness described as', 'what witnesses describe as', 'what a second victim described as'
...
#next step: create NPC event tables to run on, then have the events that are landed on append variable items to lists in order to accurately report in-game events
...
# s = rc(realname1), rc(realname2), " ", rc(aka), rc(name1), rc(name2), "was", rc(killed), rc(time), "in", rc(occurrence)
# t = "Their body was", rc(found), "with", rc(desc_as), rc(descriptive), rc(injurytype), rc(injury), "attributed to", rc(assailant)
...
### TODO: ensure variables can't be repeated###
